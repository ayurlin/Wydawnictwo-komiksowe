class EditorsController < ApplicationController
  ...
  def index
    @editor = Editor.new
    @editors = Editor.all.order("created_at DESC")
  end
  ...
  def destroy
    @editor.destroy
    respond_to do |format|
      format.html { redirect_to editors_path, notice: 'Editor was successfully destroyed.' }
  ...
  private
    ...
    def editor_params
      params.require(:editor).permit(:content, :name)
    end
end
